...
function PrivacyPolicy() {
    const [ text]  = useTypewriter({
        ...
        loop:{},
         ...
         const metadata = {
            title: "Privacy Policy - Umbrella Custom Packaging",
...
<div className="bg-[#B8B6FA99] grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 mt-8 py-2.5 sm:px-5 px-3 rounded-md w-full">
  ...
  <div className="flex  justify-start gap-1 items-center">
    ...
    <strong className="text-[15px] font-light sm:whitespace-nowrap  opacity-80 whitespace-pre-wrap text-[#111111] ">Quickest Turnaround</strong>
            ...
            <div>
    <p className='text-[#333333] text-[14px] font-sans mb-4 p-2'>
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Privacy</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Data Collection</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Registration</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Order</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Cookies</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Log Files</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Communications from the Site</h2><br />

        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Special Offers and Updates</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Newsletter</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Customer Service</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Legal Disclaimer</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Third-Party Intermediaries</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Business Transitions</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Choice/Opt-out</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Links</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Security</h2><br />
        ...
        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Supplementation of Information</h2><br />

        <h2 className=' m-0 sm:text-[32px] text-[28px] font-semibold font-sans'>Notification of Changes</h2><br />
