...
function PackagingBanner({
  ...
  return (
    ...
    <div className=' sm:max-w-6xl max-w-[95%] my-2 mt-5 mx-auto rounded-[8px] h-[300px] p-5 bg-[#00000084] bg-cover bg-no-repeat bg-blend-multiply' style={{backgroundImage:`url(${bgImage})`}}>
     ...
     <strong className='text-center text-[14px] text-[#E97900] font-semibold' >{title}</strong>
      <label className='md:text-[38px] text-[25px] font-semibold leading-9 pt-2 text-center text-[#fff]' >{subTitle}</label>
      <Link to={url}>
