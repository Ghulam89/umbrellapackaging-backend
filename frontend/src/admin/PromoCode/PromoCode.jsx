  ...
  const removeFunction = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${Base_url}/promo/delete/${id}`)
          .then((res) => {
            if (res.status === 200) {
  ...
  return (
    <>
      <div className="flex justify-between items-center">
        <h2 className="main_title">Promo Code</h2>
        <Button
      ...
      <AddPromoCode  isModalOpen={isUpdateOpen}
            ...
            <table className="min-w-full mb-0">
              <thead className="bg-primary rounded-lg">
                <tr>
                  ...
                  <th className="text-sm text-white font-bold px-6 py-4">Code</th>
                  <th className="text-sm text-white font-bold px-6 py-4">Discount</th>
